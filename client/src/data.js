const displayName = "Martin Kyalo";
const bannerDescription = "Developer from Kenya";
const mediumUrl =
  "https://api.allorigins.win/raw?url=https://medium.com/feed/@huishun";
const mediumFilterKeyword = "technology";
const email = "contact@martinkyalo.me";
const githubUrl = "https://github.com/Martinkkyalo10";
const linkedInUrl = "https://github.com/Martinkkyalo10/";
...
const projects = [
  ...
  },
  {
    title: "Narie",
    description:
      "A beginner-friendly itinerary planner, perfectly customisable to suit your needs.",
  ...
  },
  {
    ...
    description:
      "A template that gives content creators full control over the design of their site and content management system.",
  ...
  },
  {
    ...
    description:
      "An easy and fast way to download free books offered by Springer.",
  ...
  },
  {
    ...
    description:
      "A WordPress theme and site for me to document and share my coding journey.",
    stack: ["PHP", "jQuery"],
