            ...
            <Fade bottom key={index}>
              ...
              >
                <div className="card text-white background-dark-lg mb-3">
                  <img
                    alt=""
                    className="card-img-top object-top d-none d-md-block"
                    src={require("../assets/" + project.imgName)}
                  />
                  <img
                    alt=""
                    className="card-img-left d-none d-sm-block d-md-none"
                    src={require("../assets/" + project.imgName)}
                  />
                  <div className="card-body">
                    <div>
                      <h5 className="card-title">{project.title}</h5>
                      <p className="card-text remarks">{project.description}</p>
                    </div>
                    <div className="label-wrapper">
                      {project.stack.map((tech, i) => (
                        <span
                          key={i}
                          className={`label ${
                            filterArr.indexOf(tech) > -1 ? "active" : ""
                          }`}
